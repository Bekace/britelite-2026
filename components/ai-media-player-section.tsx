        ...
        <div className="relative">
          <div className="relative bg-gradient-to-br from-[#5eead4] via-[#4ade80] to-[#5eead4] rounded-3xl p-4 lg:p-2 overflow-hidden">
            ...
            <div className="relative z-10">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/67bf7352968940a8f367cd2b_ai.jpg%281%29%281%29%281%29%281%29-JlnRF6aguEy8kGH3VFifXE8apY7KnY.jpeg"
